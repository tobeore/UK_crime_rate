...
<img width="677" height="478" alt="UK Visualization" src="https://github.com/user-attachments/assets/0475b7ca-88e2-4ef5-a3bd-6246187d7d92" />
Figure 1: Trend of total offences over time (2012–2023)
...
## 💡 Key Insights
  ...
  * **Yearly Crime Rate**: Crime rates show a steady upward trend over multiple years, suggesting systemic issues rather than short-term fluctuations. The dip observed in 2020/21 likely reflects reduced mobility during COVID-19 restrictions rather than an actual reduction in crime. The subsequent increase reinforces the need for long-term data-driven policy interventions rather than reactive measures.
  ...
  * **Types of Offences**: Theft offenses have the highest occurrence, followed by "Violence against the person" and "Fraud Offenses".
   ...
   Figure 2: Distribution of offence types across the UK
